    ...
    <View>
      ...
      <Modal transparent visible={visible}>
        <View
          ...
          className='flex-1 absolute h-full w-full bg-[#545454]/60 '
        >
          <Animated.View
            style={[
              {
          ...
          >
            <View className=''></View>
            <TouchableOpacity className='flex-row  items-center p-2 rounded-t-2xl border-b-[1px] border-[#CCCCCC] ml-1 mr-1'>
              <Icon name='brush' size={25} />
              <Text className='ml-2 font-bold text-[16px]'>Edit</Text>
            </TouchableOpacity>
            <TouchableOpacity className='flex-row items-center p-2 ml-1 mr-1 rounded-b-2xl'>
