    ...
    <View className="h-full">
        ...
        <View className="m-5 ">
            <View className="bg-[#FBFBFB] rounded-t-2xl border-b-[1px] border-[#CCCCCC]">
                ...
                <TextInput placeholder="Nama Sebelumnya" className="pl-4 pr-4 pt-2 pb-4"></TextInput>
            </View>
            ...
            <View className="bg-[#FBFBFB] border-b-[1px] border-[#CCCCCC]">
                ...
                <TextInput placeholder="Kondisi Sebelumnya" className="pl-4 pr-4 pt-2 pb-4"></TextInput>
            </View>
