        ...
        <View style={styles.root}>
            ...
            <View style={styles.inputan}>
                <View style={styles.inputanemail}>
                    <Image source={require('../../../assets/email-logo.png')} style={styles.logoemail} resizeMode="contain"></Image>
                    <TextInput
                        style={styles.email}
                ...
                <View style={styles.inputpassword}>
                    <Image source={require('../../../assets/password-logo.png')} style={styles.logopassword} resizeMode="contain"></Image>
                    <TextInput
